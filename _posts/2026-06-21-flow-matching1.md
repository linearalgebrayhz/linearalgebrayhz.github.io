...
> Example 6 (Ornstein–Uhlenbeck Process): consider a constant diffusion coefficient $$\sigma_t = \sigma \geq 0$$ and a constant linear drift $$u_t(x) = -\theta x$$ for some $$\theta > 0$$. Then the SDE in (8) becomes
>
> $$
> \begin{equation}
